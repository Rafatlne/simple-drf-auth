...
from user.views import BaseUserPasswordChangeViewset, BaseUserViewSet,TokenCreateView, TokenDestroyView, BasePassengerUserViewSet, BaseUserActivation, BaseUserPasswordChangeViewset, BaseUserPasswordForgotViewset, BaseUserPasswordForgotActivationViewset, BaseUserProfileViewSet
...
urlpatterns = [
    path("api/v1/users/profile/", BaseUserProfileViewSet.as_view(), name="profile"),
